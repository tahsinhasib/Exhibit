...
{
    public partial class HostProfile : Form
    {
        public HostProfile(string passedfromUserProfile)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                string query1 = "SELECT Username FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query2 = "SELECT Password FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query3 = "SELECT Phone FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query4 = "SELECT Email FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query5 = "SELECT Gender FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query6 = "SELECT Account FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
                ...
                string query7 = "SELECT Address FROM UserDataTable WHERE Username = '" + passedfromUserProfile + "'";
        ...
        private void HostProfile_Load(object sender, EventArgs e)
        {
